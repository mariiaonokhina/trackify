     ...
     <section className="bg-[#f8f9fa] px-10 py-16">
       ...
       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
         <div className="bg-white shadow p-4 rounded-xl">
           ...
           <p className="text-sm text-gray-600">Track the total number of job applications submitted.</p>
         </div>
         <div className="bg-white shadow p-4 rounded-xl">
           <h3 className="font-bold text-lg">Applications in Progress</h3>
           <p className="text-sm text-gray-600">Monitor the applications that are currently in progress.</p>
         </div>
         <div className="bg-white shadow p-4 rounded-xl">
           <h3 className="font-bold text-lg">Scheduled Interviews</h3>
           <p className="text-sm text-gray-600">Stay updated on upcoming interview schedules.</p>
         </div>
         <div className="bg-white shadow p-4 rounded-xl">
           <h3 className="font-bold text-lg">Offers Received</h3>
           <p className="text-sm text-gray-600">Keep track of job offers received.</p>
         </div>
         <div className="bg-white shadow p-4 rounded-xl">
           <h3 className="font-bold text-lg">Rejections</h3>
           <p className="text-sm text-gray-600">View the number of job rejections for better insights.</p>
         </div>
       </div>
     </section>
   </div>
